...
sm=df.sample()
print(sm)
print("SepalLengthCm max : ",df["SepalLengthCm"].max())
print("SepalLengthCm max : ",df["SepalLengthCm"].min())
print("PetalWidthCm max : ",df["PetalWidthCm"].max())
print("PetalWidthCm max : ",df["PetalWidthCm"].min())
#3
print("SepalLengthCm mean : ",df["SepalLengthCm"].mean())
print("SepalLengthCm median : ",df["SepalLengthCm"].median())
print("PetalWidthCm mean : ",df["PetalWidthCm"].mean())
print("PetalWidthCm meadian: ",df["PetalWidthCm"].median())
#2

for i in range (200):
  df["Species"]Iris-setosa')
  f=df.groupby("Species")
print(f)
